...
class ReportTemplateRegistry(IReportTemplateRegistry):
    ...
    def __init__(self) -> None:
        ...
        self.register_template("ara_v1_1_report", [
            {"title": "Executive Summary", "content": "High-level summary of the report."},
            {"title": "Evidence", "content": "Structured evidence and data points."},
            {"title": "Analysis", "content": "In-depth analysis of the evidence."},
            {"title": "Confidence Assessment", "content": "Confidence score and uncertainties generated by the ConfidenceEngine."},
            {"title": "Limitations", "content": "Known gaps and limitations detected by the SelfVerificationEngine."},
            {"title": "Final Answer", "content": "The definitive conclusion based on the research."},
            {"title": "Sources", "content": "Bibliography and references."},
        ])
